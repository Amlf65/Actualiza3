...
switch ($t_orden){
  case 1:
    $resultado = $conexion->query('SELECT * FROM impresoras ORDER BY nombre');
    break;
  case 2:
    $resultado = $conexion->query('SELECT * FROM impresoras ORDER BY marca');
    break;
  case 3:
    $resultado = $conexion->query('SELECT * FROM impresoras ORDER BY modelo');
    break;
  case 4:
    $resultado = $conexion->query('SELECT * FROM impresoras ORDER BY ubicacion');
    break;
  default:
    $resultado = $conexion->query('SELECT * FROM impresoras ORDER BY id');
    break;
}
...
<body class="container w-100 mx-auto">
  ...
  <section class="mx-auto bg-white">
    <article class="bg-white text-primary font-bold row py-2 rounded">
      <form class="col-3 col-md-2" action="index.php" method="POST">
          <input type="hidden" name="orden" value="1">
          <input type="submit" value="Nombre" class="border-0 bg-white text-black negrita texto14">
      </form>
      <form class="d-none d-md-inline col-md-2" action="impresoras.php" method="POST">
      ...
      <form class="col-5 col-md-4" action="impresoras.php" method="POST">
      ...
      <article class="bg-white text-black row border-top  py-1">
        ...
        <div class="col-2 col-md-1">  
            <button class='btn btn-primary btn-small btnEditar w-100'
                ...
                data-conexion="<?php echo $f['Conexion']; ?>"
    ...
    <div class="modal fade " id="Insertar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl " role="document">
        <div class="modal-content" class="p-0 ">
          <form action="impresoras/insertarElemento.php" method="POST" enctype="multipart/form-data" >
            ...
            <div class="form-group row" >
              ...
              <div class="form-group row" >
                ...
                <label class="col-12 col-md-6" for="conexion">Conexión<br/>  
                <input type="text" name="conexion" id="conexion" placeholder="Tipo conexión" required class="form-control mifoco"></label>
              </div>
              <div class="form-group row" >
    ...
    <div class="modal fade " id="Editar" tabindex="-1" role="dialog" aria-labelledby="modalEditarLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl " role="document">
        <div class="modal-content" class="p-0 ">
          <form action="impresoras/editarElemento.php" method="POST" enctype="multipart/form-data" >
            <div class="modal-header">
            ...
            <div class="form-group row" >
              ...
              <div class="form-group row" >
                    ...
                    <label class="col-12 col-md-6" for="conexioned">Conexión<br/>  
                    <input type="text" name="conexion" id="conexioned" placeholder="Tipo conexión" required class="form-control mifoco"></label>
              </div>
              <div class="form-group row" >
...
<script>
    $(document).ready(function() {
      ...
      $(".eliminar").click(function() {
        $.ajax({
          url: 'impresoras/eliminarElemento.php',
          method: 'POST',
          data: {
            id: idEliminar
          }
      ...
      $(".btnEditar").click(function() {
        ...
        var conxEditar = $(this).data('conexion');
