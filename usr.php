...
<body class="container w-75 mx-auto border-0 bg-light">
  ...
  <section class="container">
    <div class="row justify-content-center">
      <a href="incidencias_user_ins.php" class="col-12 col-lg-7 btn btn-primary my-1 texto12 negrita" >Registrar Incidencia</a>
      <a href="incidencias_user_ver.php" class="col-12 col-lg-7 btn btn-primary my-1 texto12 negrita" >Consultar incidencias</a>
