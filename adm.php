  ...
  <header class="text-center">
    ...
    <section class="container">
      <div class="row justify-content-center">
        ...
        <a href="monitores.php" class="col-12 col-lg-7 btn btn-primary my-1 texto12 negrita" >Inventario de Monitores</a>
        <a href="impresoras.php" class="col-12 col-lg-7 btn btn-primary my-1 texto12 negrita" >Inventario de Impresoras</a>
        <a href="incidencias.php" class="col-12 col-lg-7 btn btn-primary my-1 texto12 negrita" >Gestión de Incidencias</a>
        <a href="usuarios.php" class="col-12 col-lg-7 btn btn-primary my-1 texto12 negrita" >Mantenimiento de Usuarios</a>
        <a href="descargas" class="d-none d-md-inline col-lg-7 btn btn-primary my-1 texto12 negrita" >Descargas</a>
        <a href="index.php" class="col-12 col-lg-7 btn btn-primary my-1 texto12 negrita" >Salir</a>
    </div>
  </section>
</body>
